...
import * as Plugin_0 from '/Users/oliverbi/workspace/learn/address-demo/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/oliverbi/workspace/learn/address-demo/src/app.ts',
    },
    {
      apply: Plugin_1,
